...
for (flux.name in flux.name.all){
  ...
  # save output csv
  write.csv(df.out, paste0(flux.name, "/GHCN_SensitivityBaseline_PLS_OutputAll.csv"), row.names=F, quote=F)
  ...
  ggsave(paste0(plot.dir, "GHCN_PheasantBranch_SensitivityBaseline_PLS_", flux.name, "_p.fit.group.baseline.png"),
  ...
  ggsave(paste0(plot.dir, "GHCN_PheasantBranch_SensitivityBaseline_PLS_", flux.name, "_p.facet.obs.PCR.png"),
  ...
  p.baseline.discharge <-
    ...
    theme_bw() +
    theme(panel.grid=element_blank())
  ggsave(paste0(plot.dir, "GHCN_PheasantBranch_SensitivityBaseline_PLS_", flux.name, "_p.baseline.discharge.png"),
  ...
  p.dens.LULC.baseline <-
    ...
    theme(panel.grid=element_blank(),
          legend.position="bottom")
  ggsave(paste0(plot.dir, "GHCN_PheasantBranch_SensitivityBaseline_PLS_", flux.name, "_p.dens.LULC.baseline.png"),
  ...
  p.ribbon <- 
    ...
    theme_bw() +
    theme(panel.grid=element_blank())
  ggsave(paste0(plot.dir, "GHCN_PheasantBranch_SensitivityBaseline_PLS_", flux.name, "_p.ribbon.png"),
  ...
  p.change.baseline <- 
    ...
    theme(panel.grid=element_blank(),
          legend.position="bottom")
  ggsave(paste0(plot.dir, "GHCN_PheasantBranch_SensitivityBaseline_PLS_", flux.name, "_p.change.baseline.png"),
